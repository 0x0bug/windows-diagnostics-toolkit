...
function Get-WdtDiagnosticDefinition {
    return @(
        ...
        [pscustomobject]@{ Name = 'Disk'; Title = 'Disk Health'; Label = 'Disk health'; Script = 'disk-health.ps1'; Recommended = $true },
        ...
        [pscustomobject]@{ Name = 'Services'; Title = 'Services Check'; Label = 'Services and startup'; Script = 'services-check.ps1'; Recommended = $false },
